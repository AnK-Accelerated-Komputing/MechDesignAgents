...
class CustomLLama32VisionClient:
    ...
    def create(self, params):
        ...
        client = instructor.from_openai(OpenAI(base_url="https://api.groq.com/inference/v1", api_key=getenv("GROQ_API_KEY")), mode=instructor.Mode.JSON)
...
config_list_text = [{"model": "llama-3.2-90b-vision-preview", "api_key": getenv("GROQ_API_KEY"), "base_url": "https://api.groq.com/inference/v1"}]
