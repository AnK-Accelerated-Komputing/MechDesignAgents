...
@primary_analyzer.register_for_llm(description="Analyze engineering drawing using Groq vision model")
@verification_agent.register_for_llm(description="Analyze engineering drawing using Groq vision model")
@final_reporter.register_for_llm(description="Analyze engineering drawing using Groq vision model")
